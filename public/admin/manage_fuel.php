                            ...
                            <table id="datatable-buttons"
                                ...
                                foreach ($record as $key) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#"
                                               onclick="editForm(event, <?php echo $key['id']; ?>,'edit_fuel.php')"
                                               class="btn btn-primary waves-effect waves-light"><i class="fa fa-edit"
                                                                                                   aria-hidden="true"></i></a>
                                            <a href="#" class="btn btn-danger"
                                               onclick="return confirm('Are you sure you want to delete this item?') && delForm(event, <?php echo $key['id']; ?>,'app/fuel_crud.php');"><i
