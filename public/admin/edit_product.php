                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active p-3" id="home" role="tabpanel">
                                <form name="myform" action="app/product.php" class="row" method="POST"
                                      enctype="multipart/form-data" onsubmit="return validation()" id="edit_service">
                                    ...
                                    foreach ($record as $key) { ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="text" name="heading"
                                                   value="<?php echo $key['heading'] ?>" required=""
                                                   pattern="^[a-z A-Z 0-9 ]+$" / >
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" type="text" name="shortcontent" required=""
                                                      pattern="^[a-z A-Z 0-9 ]+$" /
                                            ><?php echo $key['shortcontent'] ?></textarea>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" type="text" name="content" required=""
                                                      pattern="^[a-z A-Z 0-9 ]+$"
                                                      id="ckeditor"><?php echo $key['content'] ?>"</textarea>
                                        </div>


                                        <div class="form-group col-md-6">
                                            <label class="control-label">Existing Photo</label><br>
                                            <input type="hidden" value="<?php echo $key['photo'] ?>"
                                                   name="old_photo_img">
                                            <img class="img-fluid" src="../assets/images/<?php echo $key['photo'] ?>"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="hidden" value="<?php echo $key['banner'] ?>"
                                                   name="old_banner_img">
                                            <img class="img-fluid" src="../assets/images/<?php echo $key['banner'] ?>"
                                                 style="width:100px;height:auto;"><br>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <h6 class="p-2 seo-info" style="background-color: lightgrey;">SEO
                                                Information</h6>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="text" name="metatitle"
                                                   value="<?php echo $key['metatitle'] ?>" pattern="^[a-z A-Z 0-9 ]+$"/>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">Meta Description</label>
                                            <textarea class="form-control" type="text" name="metadescription"
                                                      pattern="^[a-z A-Z 0-9 ]+$"/><?php echo $key['metadescription'] ?></textarea>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">Meta keywords</label>
                                            <textarea class="form-control" type="text" name="keywords"
                                                      pattern="^[a-z A-Z 0-9 ]+$"/><?php echo $key['keywords'] ?></textarea>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="control-label">Meta robots</label>
                                            <textarea class="form-control" type="text" name="robots"
                                                      pattern="^[a-z A-Z 0-9 ]+$"/><?php echo $key['robots'] ?></textarea>
                                        </div>

                                        <div class="form-group col-md-12">

                                            <button class="btn btn-primary" type="submit" name="update"
                                                    onclick="editService()">Update
                                            </button>
