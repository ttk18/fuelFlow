                            ...
                            <div class="tab-pane active p-3" id="home" role="tabpanel">
                                <form name="myform" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" placeholder="Invoice Number"
                                                   value="INV-0001" autocomplete="off" name="uno" required=""
                                                   readonly="true">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" value="2023-12-07" id="orderDate"
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" placeholder="Client Name" value=""
                                                   autocomplete="off" name="uno" required="" readonly="">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" value="" id="orderDate"
                                                   name="orderDate" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <table class="table" id="productTable">
                                        ...
                                        <tr id="row1" class="0">
                                            ...
                                            <td style="padding-left:20px;">
                                                <input type="text" name="rate[]" id="rate1" autocomplete="off"
                                            ...
                                            <td style="padding-left:20px;">
                                                <div class="form-group">
                                                    <input type="number" name="quantity[]" id="quantity1"
                                                           onkeyup="getTotalAndProductData(1)"
                                                           onchange="handleQuantityChange(1)" autocomplete="off"
                                                           class="form-control" min="1">
                                                </div>
                                            </td>
                                            <td>
                                                <input type="text" name="total[]" id="total1" autocomplete="off"
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-primary btn-flat "
                                                        ...
                                                        data-loading-text="Loading..."><i class="fa fa-plus"></i>
                                                </button>
                                            </td>
                                            <td>

                                                <button type="button" class="btn btn-danger  removeProductRowBtn"
                                                        id="removeProductRowBtn" onclick="removeProductRow(1)"><i
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" placeholder="" value=""
                                                   autocomplete="off" name="" required="" readonly="">
                                        </div>
