                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active p-3" id="home" role="tabpanel">
                                <form name="myform1" class="row" action="app/web_crud.php" method="POST"
                                      enctype="multipart/form-data" onsubmit="return validation()" id="validate">
                                    <?php
                                    ...
                                    foreach ($record1 as $key1) { ?>
                                        ...
                                        <input class="form-control" type="hidden" name="id"
                                               value="<?php echo $key1['id']; ?>">


                                        <div class="form-group col-md-6">
                                            <label class="control-label">Existing Photo</label><br>
                                            <input type="hidden" value="<?php echo $key1['photo1'] ?>"
                                                   name="old_photo1_img">
                                            <img class="img-fluid" src="../assets/images/<?php echo $key1['photo1'] ?>"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="file" id="photo1" name="photo1"
                                                   value="<?php echo $key1['photo1'] ?>" accept=".png,.jpeg">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="text" name="title"
                                                   value="<?php echo $key1['title'] ?>" required/ ><br><br>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">Existing Photo</label><br>
                                            <input type="hidden" value="<?php echo $key1['photos'] ?>"
                                                   name="old_photos_img">
                                            <img class="img-fluid" src="../assets/images/<?php echo $key1['photos'] ?>"
                                                 style="width:100px;height:auto;"><br>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="file" name="photos" id="photos"
                                                   value="<?php echo $key1['photos'] ?>" accept=".png,.jpeg">
                                        </div>

                                        <div class="col-md-12">
                                            <h6 class="p-2 seo-info" style="background-color: lightgrey;">Google
                                                ReCaptcha</h6>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">Site-key</label>
                                            <input class="form-control" type="text" name="sitekey"
                                                   value="<?php echo $key1['sitekey'] ?>" required>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">Secret-key</label>
                                            <input class="form-control" type="text" name="secretkey"
                                                   value="<?php echo $key1['secretkey'] ?>" required>
                                        </div>
                            ...
                            <div class="tab-pane p-3" id="settings" role="tabpanel">
                                <form class="row" action="app/web_crud.php" method="POST">
                                    ...
                                    foreach ($record4 as $key4) { ?>
                                        ...
                                        <input class="form-control" type="hidden" name="id"
                                               value="<?php echo $key4['id']; ?>">

                                        <div class="form-group col-md-6">
                                            <label class="control-label">SMTP Username</label>
                                            <input class="form-control" type="text" name="username"
                                                   value="<?php echo $key4['username'] ?>" / >
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="control-label">SMTP Password</label>
                                            <input class="form-control" type="password" name="password"
                                                   value="<?php echo $key4['password'] ?>">
                                        </div>
