...
if($_SESSION['language'] == 'vi'){
    $lang = include "assets/locales/vi/lang.php";
}else {
    $lang = include "assets/locales/en/lang.php";
}
?>
<?php
    ...
    <div class="col-md-6  d-flex ">
        <div class="col-md-8 mx-auto ">
            ...
            <div class="text-center front-logo">
                <a href="index.php" class="logo logo-admin"><img src="assets/images/<?php echo $key1['photo1']; ?>"
                                                                 alt="logo" width="330px"></a>
            </div>
